# decide_next_process function represents an applicant tracking system that takes your cv as a resume and compare it with the wanted requirements and decide whether or not you pass to next step
